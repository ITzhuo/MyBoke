...
import com.zcy.ssm.blog.dto.ArticleParam;
...
import com.zcy.ssm.blog.service.TagService;

import com.zcy.ssm.blog.entity.Category;
import com.zcy.ssm.blog.entity.Tag;
...
public class BackArticleController {
    ...
    public String index(@RequestParam(required = false, defaultValue = "1") Integer pageIndex,
        ...
        System.out.println("目录admin-BackArticle-1");
    ...
    public String insertArticleView(Model model) {System.out.println("目录admin-BackArticle-2");
    ...
    public String insertArticleSubmit(HttpSession session, ArticleParam articleParam) {
        Article article = new Article();System.out.println("目录admin-BackArticle-3");
        //用户ID
    ...
    public void deleteArticle(@PathVariable("id") Integer id) {System.out.println("目录admin-BackArticle-4");
    ...
    public ModelAndView editArticleView(@PathVariable("id") Integer id) {
        ...
        System.out.println("目录admin-BackArticle-5");
    ...
    public String editArticleSubmit(ArticleParam articleParam) {
        System.out.println("目录admin-BackArticle-6");
