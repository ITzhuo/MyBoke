...
import com.zcy.ssm.blog.service.OptionsService;
...
public class BackOptionsController {
    ...
    public ModelAndView index()  {System.out.println("目录admin-BackOptions-1");
    ...
    public ModelAndView editOptionView()  {System.out.println("目录admin-BackOptions-2");
        ModelAndView modelAndView = new ModelAndView();
        Options option = optionsService.getOptions();
        modelAndView.addObject("option",option);
    ...
    public String editOptionSubmit(Options options)  {System.out.println("目录admin-BackOptions-3");
        //如果记录不存在，那就新建
