...
public class PageController {
    ...
    public String pageDetail(@PathVariable("key") String key, Model model) {System.out.println("home-Pag-1");
    ...
    public String articleFile(Model model) {System.out.println("home-Pag-2");
    ...
    public String siteMap(Model model) {System.out.println("home-Pag-3");
        //文章显示
        List<Article> articleList = articleService.listAllNotWithContent();
        model.addAttribute("articleList", articleList);
        //分类显示
