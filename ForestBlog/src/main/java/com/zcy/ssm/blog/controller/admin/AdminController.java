...
import static com.zcy.ssm.blog.util.MyUtils.getIpAddr;
...
public class AdminController {
    ...
    public String index(Model model) {
        System.out.println("目录admin-adm-1");
        //文章列表
    ...
    public String loginPage() {
        System.out.println("目录admin-adm-2");
        return "Admin/login";
    }
    ...
    public String loginVerify(HttpServletRequest request, HttpServletResponse response) {
        Map<String, Object> map = new HashMap<String, Object>();System.out.println("目录admin-adm-3");
    ...
    public String logout(HttpSession session) {System.out.println("目录admin-adm-4");
