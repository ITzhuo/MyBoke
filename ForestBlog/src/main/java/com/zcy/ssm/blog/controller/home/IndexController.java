package com.zcy.ssm.blog.controller.home;
...
public class IndexController {
    ...
    @RequestMapping("/404")
    public String NotFound(@RequestParam(required = false) String message, Model model) {System.out.println("home-Ind-3");
