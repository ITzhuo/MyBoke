...
import com.zcy.ssm.blog.entity.Link;
import com.zcy.ssm.blog.service.LinkService;
...
public class BackLinkController {
    ...
    public ModelAndView linkList()  {System.out.println("目录admin-BackLink-1");
    ...
    public ModelAndView insertLinkView()  {System.out.println("目录admin-BackLink-2");
        ModelAndView modelAndView = new ModelAndView();
    ...
    public String insertLinkSubmit(Link link)  {System.out.println("目录admin-BackLink-3");
    ...
    public String deleteLink(@PathVariable("id") Integer id)  {
        System.out.println("目录admin-BackLink-4");
    ...
    public ModelAndView editLinkView(@PathVariable("id") Integer id)  {
        System.out.println("目录admin-BackLink-5");
        ModelAndView modelAndView = new ModelAndView();
    ...
    public String editLinkSubmit(Link link)  {
        System.out.println("目录admin-BackLink-6");
        link.setLinkUpdateTime(new Date());
